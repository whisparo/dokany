...
export const customerStats = sqliteTable(
  'customer_stats',
  {
    ...
    customerId: text('customer_id')
      .notNull()
      .references(() => customers.id, { onDelete: 'cascade', onUpdate: 'cascade' }), // ✅ هنا الـ references مسموحة لأنها لجدول فرعي
