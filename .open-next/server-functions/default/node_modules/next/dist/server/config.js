...
function assignDefaults(dir, userConfig, silent) {
    ...
    if (!((_process_env___NEXT_VERSION = "15.2.0") == null ? void 0 : _process_env___NEXT_VERSION.includes('canary')) && !process.env.__NEXT_TEST_MODE && !process.env.NEXT_PRIVATE_LOCAL_DEV) {
        ...
        if ((_result_experimental7 = result.experimental) == null ? void 0 : _result_experimental7.ppr) {
            ...
            throw Object.defineProperty(new CanaryOnlyError('experimental.nodeMiddleware'), "__NEXT_ERROR_CODE", {
                value: "E650",
                enumerable: false,
                configurable: true
            });
