...
async function handleAction({ req, res, ComponentMod, serverModuleMap, generateFlight, workStore, requestStore, serverActions, ctx, metadata }) {
    ...
    if (!hasServerActions(serverActionsManifest)) {
        const error = actionId !== null && !(0, _serverreferenceinfo.mightBeServerReferenceId)(actionId) ? (0, _actionutils.getInvalidServerReferenceIdError)(actionId) : (0, _actionutils.getActionNotFoundError)(actionId);
 ...
 */ function getActionModIdOrError(actionId, serverModuleMap) {
    ...
    if (entry == null) {
        ...
        throw (0, _serverreferenceinfo.mightBeServerReferenceId)(actionId) ? (0, _actionutils.getActionNotFoundError)(actionId) : (0, _actionutils.getInvalidServerReferenceIdError)(actionId);
    }
    return entry.id;
}
