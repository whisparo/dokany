...
function startPPRNavigation(oldCacheNode, oldRouterState, newRouterState, prefetchData, prefetchHead, isPrefetchHeadPartial, scrollableSegmentsResult) {
    const segmentPath = [];
    return updateCacheNodeOnNavigation(oldCacheNode, oldRouterState, newRouterState, false, prefetchData, prefetchHead, isPrefetchHeadPartial, segmentPath, scrollableSegmentsResult);
}
function updateCacheNodeOnNavigation(oldCacheNode, oldRouterState, newRouterState, didFindRootLayout, prefetchData, prefetchHead, isPrefetchHeadPartial, segmentPath, scrollableSegmentsResult) {
    ...
    for(let parallelRouteKey in newRouterStateChildren){
        ...
        if (newSegmentChild === _segment.DEFAULT_SEGMENT_KEY) {
            ...
            if (oldCacheNodeChild !== undefined && oldRouterStateChild !== undefined) {
                ...
                // the children.
                taskChild = updateCacheNodeOnNavigation(oldCacheNodeChild, oldRouterStateChild, newRouterStateChild, didFindRootLayout, prefetchDataChild, prefetchHead, isPrefetchHeadPartial, newSegmentPathChild, scrollableSegmentsResult);
            } else {
